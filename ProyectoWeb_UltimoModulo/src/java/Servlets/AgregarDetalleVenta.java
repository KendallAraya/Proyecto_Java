...
public class AgregarDetalleVenta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int idVenta = logica.ObtenerUltimoId(); 

            detalleVenta.setIdVenta(idVenta);
            detalleVenta.setIdProducto(Integer.parseInt(request.getParameter("txtIdProducto"))); 
            detalleVenta.setCantidad(Float.parseFloat(request.getParameter("txtCantidad")));

            resultado = logica.InsertarDetalleVenta(detalleVenta, idVenta); 
